...
PreparedStatement stmt = null;
	...
	System.out.println(sk+"u_search_list.jsp");
	System.out.println(sv+"u_search_list.jsp");
	...
	try{
		...
		conn = DriverManager.getConnection
				("jdbc:mysql://localhost:3306/slip?useUnicode=true&characterEncoding=utf-8","root","1234");
	        ...
	        <tbody>
	         <tr>
	            <td> <%=id %></td>
					...
					<td> <%=dept %></td>
					<td> <%=layer %></td>
					<td> <a href="u_Detail.jsp?num=<%=lecturenum%>"><%=lecturenum %></a></td>
	         </tr>
	      </tbody>
	      <% 
...
%>		
  ...
  out.println("<a href=u_search_list.jsp?mypage=" + l+ ">"+ l + "|</a>");
    }
 }
 else{
    out.println("1"); 
	...
	%>
	 ...
	 <input type="submit" value="이전 목록" onclick="javascript:location.href='u_list.jsp'" >
	</div>
</body>
</html>