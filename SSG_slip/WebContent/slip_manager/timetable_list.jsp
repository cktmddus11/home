...
<body>
	...
	<div id="funclog">
	  <div class="boardcss_list_table">
		...
		ResultSet rs0 = null;
		 ...
		 try{
			   ...
			   int datacount=0; 
			    ...
			    stmt = conn.prepareStatement("select count(*) from t_file");
		...
		ArrayList<FileDTO> fileList = new t_FileDAO().getList();
	...
	%>			
			...
			out.write("<a href=\""+request.getContextPath() + "/t_downloadAction?file=" +
	...
	%>
       ...
       out.println("<a href=timetable_list.jsp?mypage=" + l+ ">"+ l + "|</a>");
         }
      }
      else{
         out.println("1"); 
