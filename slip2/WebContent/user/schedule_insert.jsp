...
try{
	...
	String sql = "select *from calendar where id="+id+" and date='"+date+"'";
	...
	rs2 = stmt2.executeQuery("select no from calendar where id="+id+" and date="+date);
...
<body>
	<script>
	alert("추가 되었습니다.");
	window.location.href = "calpage.jsp";
	</script>
</body>
</html>