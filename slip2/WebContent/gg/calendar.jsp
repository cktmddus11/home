...
<body>
	<form name="calendarFrm" id="calendarFrm" action="" method="post">
		<div id="content" style="width:712px">
			...
			<tr>
				<td align="right">
				<input type="button" onclick="javascript:location.href='/slip2/gg/calendar.jsp'" value="오늘"/>
				</td>
			</tr>
	...
	<table border="0" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF">
		...
		<%
			...
			for(int index = 1; index <= endDay; index++){ // endDay 마지막 일 
				...
				// 달력 칸 생성(열 생성)
				out.println("<td style='cursor:pointer' onclick=location.href='view_form.jsp?date="+iUseDate+"' valign='top' align='left' height='92px' bgcolor='"+backColor+"' nowrap>");
				%>
				<font color='<%=color %>'>
...
try{
	...
	rs = stmt.executeQuery("select sch_no,task from calendar_view where id=41730062 and date="+iUseDate);
