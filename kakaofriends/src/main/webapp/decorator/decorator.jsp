...
<link rel="shortcut icon"
   ...
   type="image/x-ico">
<link
   href="https://fonts.googleapis.com/css?family=Noto+Sans+KR:100,200,300,900&display=swap"
   rel="stylesheet">
<!-- ... -->
</head>
<!-- ... -->
...
<body class="animsition">
   ...
   <header>
      ...
      <div class="container-menu-desktop">
         <!-- Topbar -->
         <div class="wrap-menu-desktop" style="top: 0; height: 140px;">
            <div class="limiter-menu-desktop container" style="height: 50%;">
               <!-- Menu desktop -->
               <div class="menu-desktop" style="width: 30%;">
                  <ul class="main-menu">
                     <li class="active-menu"><a href="product/list.store">카테고리</a>
                        <ul class="sub-menu">
               ...
               <!-- Logo desktop -->
               <div class="menu-desktop" style="width: 40%;">
            ...
            <div class="limiter-menu-desktop container"
               style="margin: auto; background-color: white; height: 10%;">
               <!-- tab header -->
               <div class="" style="margin: 0 20% 0 40%;">
                  <br>
               ...
               <ul class="topbar-mobile">
                  ...
                  <li>
                     <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="#" class="flex-c-m p-lr-10 trans-04"> My Account </a> <a
