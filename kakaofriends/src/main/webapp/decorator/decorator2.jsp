...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop" style="width: 30%;">
						<ul class="main-menu">
							<li class="active-menu"><a href="index.html">카테고리</a>
								<ul class="sub-menu">
							...
							<li class="label1" data-label1="hot"><a
								href="shoping-cart.html">고객센터</a></li>
					...
					<div class="menu-desktop"
						style="width: 40%; padding-left: 58px; padding-right: 58px;">
						<a href="../index.store" class=""> <img
							src="../images/icons/KAKAOFRIENDS_img_logo_560X5602.png"
							alt="IMG-LOGO" width="352" height="84">
						</a>
					</div>
	...
	<section class="bg0 p-t-0 p-b-140">
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-3b-52 p-t-23">
	...
	<!-- Cart 버튼 눌러서 옵션 선택 할게 있으면 이 창 뜨게 클릭하면 상품 번호로 조회해서 
	상품사진 뿌려야할듯-->
				...
				<div class="row">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="../images/phonecase1.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="../images/phonecase1.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="../images/phonecase2.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="../images/phonecase2.jpg" alt="IMG-PRODUCT">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2"> 25,000원 </span>
