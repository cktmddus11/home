...
<body class="animsition">
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="../index.store" class="logo">
						<img src="../images/icons/KAKAOFRIENDS_img_logo_560X5602.png" alt="IMG-LOGO">
					</a>
	...
	<!-- Banner -->
<div class="sec-banner bg0 p-t-80 p-b-50" style="
    padding-top: 20px;">
	</div>
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10"> <!-- style="padding-left : %" -->
